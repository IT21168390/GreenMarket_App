...
const locations = ['All', 'District 1', 'District 2', 'District 3']; // Add your districts here, and include 'All'

const categories = ['All', 'Vegetables', 'Fruits']; // Add your categories here, and include 'All'
